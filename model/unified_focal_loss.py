...
class SymmetricFocalLoss(nn.Module):
	...
	def __str__(self):
		return f'SymmetricFocalLoss(delta={self.delta}, gamma={self.gamma})'
...
class AsymmetricFocalLoss(nn.Module):
	...
	def __str__(self):
		return f'AsymmetricFocalLoss(delta={self.delta}, gamma={self.gamma})'
...
class SymmetricFocalTverskyLoss(nn.Module):
	...
	def __str__(self):
		return f'SymmetricFocalTverskyLoss(delta={self.delta}, gamma={self.gamma})'
...
class AsymmetricFocalTverskyLoss(nn.Module):
	...
	def __str__(self):
		return f'AsymmetricFocalTverskyLoss(delta={self.delta}, gamma={self.gamma})'
...
class SymmetricUnifiedFocalLoss(nn.Module):
	...
	def __str__(self):
		return f'SymmetricUnifiedFocalLoss(delta={self.delta}, gamma={self.gamma}, weight={self.weight})'
...
class AsymmetricUnifiedFocalLoss(nn.Module):
	...
	def __str__(self):
		return f'AsymmetricUnifiedFocalLoss(delta={self.delta}, gamma={self.gamma}, weight={self.weight})'